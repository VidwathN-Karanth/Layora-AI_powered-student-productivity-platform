...
export default function LoginPage() {
  return (
    <main className="min-h-screen bg-[#16181C] text-white flex items-center justify-center relative overflow-hidden p-4">
      <div className="w-full max-w-md z-10 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-xs text-white/40 mt-1">CSE Department · Autonomous Student Productivity Suite</p>
        </div>

        {/* College account requirement */}
        <div className="w-full bg-[#1A1D22]/60 border border-white/10 rounded-xl p-4 mb-6 backdrop-blur-md relative z-10 flex items-start gap-3 shadow-lg">
          ...
          <div className="flex-1 min-w-0 text-xs">
            <h4 className="font-semibold text-white mb-0.5">Use your college Google account</h4>
        ...
        <p className="mt-6 text-[11px] text-white/30 text-center max-w-xs leading-relaxed">
          Signed in but can&rsquo;t get through? Your email may not be on the CSE roster yet — ask your lecturer to add it.
        </p>

        <footer className="mt-6 text-center text-xs text-white/30 space-y-1.5 z-10">
