      ...
      <div className="w-full max-w-4xl z-10">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-2">
            <span className="text-xl font-mono text-purple-400 font-bold">AERO_ONBOARDING</span>
            <span className="text-xs font-mono text-white/30">| v1.0.4</span>
          </div>
        ...
        {/* Progress Bar */}
        <div className="w-full h-1 bg-white/5 rounded-full overflow-hidden mb-8 relative border border-white/5">
          <div 
        ...
        <div className="glass-panel-neon rounded-2xl p-6 md:p-10 min-h-[450px] flex flex-col justify-between relative overflow-hidden">
            ...
            >
              ...
              {step === 1 && (
                <div className="space-y-6">
                  <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-mono font-bold">ROUTINE_CYCLE_SETUP</h3>
                      <p className="text-xs text-white/50">Determine sleep windows, mandatory lecture schedules, and study blocks.</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="block text-xs font-mono text-purple-300/70 mb-1">WAKE_TIME</label>
                          <input 
                            type="time" 
                            value={wakeTime}
                            onChange={(e) => setWakeTime(e.target.value)}
                            className="bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-center w-full focus:outline-none focus:border-purple-500"
                          />
                        </div>
                        <div>
                          <label className="block text-xs font-mono text-purple-300/70 mb-1">SLEEP_TIME</label>
                          <input 
                            type="time" 
                            value={sleepTime}
                      ...
                      <div className="grid grid-cols-2 gap-4 pt-2">
                        <div>
                          <label className="block text-xs font-mono text-cyan-300/70 mb-1">COLLEGE_START</label>
                          <input 
                            type="time" 
                            value={collegeStart}
                            onChange={(e) => setCollegeStart(e.target.value)}
                            className="bg-white/5 border border-cyan-500/20 rounded-xl px-3 py-2 text-sm text-center w-full focus:outline-none focus:border-cyan-500"
                          />
                        </div>
                        <div>
                          <label className="block text-xs font-mono text-cyan-300/70 mb-1">COLLEGE_END</label>
                          <input 
                            type="time" 
                            value={collegeEnd}
                    ...
                    <div className="space-y-4 border-l border-white/10 pl-0 md:pl-6">
                      <label className="block text-xs font-mono text-purple-300/70 mb-1 uppercase">Free Work & Study Slots</label>
                      
                      <div className="space-y-2 max-h-[150px] overflow-y-auto pr-2">
                        {freeBlocks.map((b) => (
                          <div key={b.id} className="flex justify-between items-center bg-white/5 border border-white/5 rounded-xl px-3 py-1.5 text-xs">
                      ...
                      <div className="grid grid-cols-3 gap-2 items-end bg-white/5 p-3 rounded-xl border border-white/5">
                        <div className="col-span-3">
                          <input 
                            ...
                            className="bg-white/5 border border-white/10 rounded-lg px-2 py-1 text-xs w-full mb-2"
                          />
                        </div>
                        <div>
                          <span className="text-[10px] font-mono text-white/40 block mb-1">START</span>
                          <input type="time" value={newFreeStart} onChange={(e) => setNewFreeStart(e.target.value)} className="bg-white/10 border border-white/10 rounded px-1 py-0.5 text-xs w-full" />
                        </div>
                        <div>
                          <span className="text-[10px] font-mono text-white/40 block mb-1">END</span>
                          <input type="time" value={newFreeEnd} onChange={(e) => setNewFreeEnd(e.target.value)} className="bg-white/10 border border-white/10 rounded px-1 py-0.5 text-xs w-full" />
                        </div>
                        <button 
                          type="button" 
                          onClick={handleAddFreeBlock} 
                          className="bg-purple-600 hover:bg-purple-500 rounded p-1.5 flex items-center justify-center cursor-pointer"
                        >
              ...
              {step === 2 && (
                <div className="space-y-6">
                  <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-mono font-bold">ACADEMIC_SUBJECTS</h3>
                      <p className="text-xs text-white/50">Add subjects, credits, difficulty, and scheduling priorities.</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white/5 p-4 rounded-xl border border-white/5 space-y-3">
                      <h4 className="text-xs font-mono text-purple-400 font-bold mb-2">ADD_SUBJECT_ENTRY</h4>
                      <div>
                        <label className="block text-[10px] font-mono text-white/50 mb-1">SUBJECT_NAME</label>
                        <input 
                          type="text" 
                          value={newSubName} 
                          onChange={(e) => setNewSubName(e.target.value)}
                          placeholder="Introduction to Calculus"
                          className="w-full bg-white/5 border border-white/10 rounded-lg px-2.5 py-1.5 text-xs focus:outline-none focus:border-purple-500"
                        />
                      </div>
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          <label className="block text-[10px] font-mono text-white/50 mb-1">CODE</label>
                          <input 
                            type="text" 
                            value={newSubCode} 
                        ...
                        <div>
                          ...
                          <input 
                            ...
                            min={1} 
                            max={6}
                            className="w-full bg-white/5 border border-white/10 rounded-lg px-2.5 py-1.5 text-xs text-center"
                          />
                        </div>
                      </div>
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          ...
                          <select 
                            ...
                            className="w-full bg-white/10 border border-white/10 rounded-lg px-2 py-1 text-xs"
                          >
                      ...
                      <button 
                        ...
                        className="w-full bg-purple-600 hover:bg-purple-500 text-white rounded-lg py-2 text-xs font-mono font-bold flex items-center justify-center gap-1.5 cursor-pointer mt-3"
                      >
                    ...
                    <div className="lg:col-span-2 space-y-2 max-h-[280px] overflow-y-auto pr-2">
                      {subjects.map((sub, index) => (
                        <div key={index} className="flex items-center justify-between bg-white/5 border border-white/5 rounded-xl p-3">
                          <div>
                            <div className="flex items-center gap-2">
                              <span className="font-mono font-bold text-sm text-purple-200">{sub.name}</span>
                              <span className="text-[10px] font-mono bg-purple-950/40 text-purple-300 px-2 py-0.5 rounded border border-purple-800/30">{sub.code}</span>
                            </div>
                            <div className="flex gap-4 text-[10px] text-white/50 mt-1 font-mono">
              ...
              {step === 3 && (
                <div className="space-y-6">
                  <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-mono font-bold">STUDY_MATERIALS_UPLOAD</h3>
                      <p className="text-xs text-white/50">Upload syllabus notes, PDFs, or slides to associate resources with subjects.</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-h-[300px] overflow-y-auto pr-2">
                    {subjects.map((sub, sIdx) => {
                      const files = uploadedFiles[sIdx] || [];
                      return (
                        <div key={sIdx} className="bg-white/5 p-4 rounded-xl border border-white/5 space-y-3">
                          <div className="flex justify-between items-center border-b border-white/5 pb-2">
                            <span className="font-mono font-bold text-xs text-purple-300">{sub.name}</span>
                            <span className="text-[10px] font-mono text-white/40">{sub.code}</span>
                          </div>

                          {/* File list */}
                          <div className="space-y-1.5 min-h-[60px]">
                            {files.length === 0 ? (
                              <p className="text-[10px] text-white/30 font-mono py-4 text-center">No reference files uploaded yet</p>
                            ) : (
                              files.map((f, fIdx) => (
                                <div key={fIdx} className="flex items-center gap-2 bg-white/5 px-2.5 py-1.5 rounded-lg text-[10px] font-mono border border-white/5">
                          ...
                          <div className="flex gap-2">
                            <input 
                              ...
                              className="bg-white/5 border border-white/10 rounded-lg px-2 py-1 text-[10px] flex-1 focus:outline-none"
                            />
                            <button 
                              onClick={() => handleMockUpload(sIdx)}
                              className="bg-purple-600 hover:bg-purple-500 text-white text-[10px] font-mono font-bold px-3 py-1 rounded-lg cursor-pointer"
                            >
                              MOCK_UPLOAD
                            </button>
                          </div>
              ...
              {step === 4 && (
                <div className="space-y-6">
                  <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-mono font-bold">EXTRA_CURRICULAR_ACTIVITIES</h3>
                      <p className="text-xs text-white/50">Register hobbies, gym, music, or physical routines to avoid study burnout.</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    {/* Add activity form */}
                    <div className="bg-white/5 p-4 rounded-xl border border-white/5 space-y-3">
                      <h4 className="text-xs font-mono text-purple-400 font-bold mb-2">ADD_ACTIVITY_ENTRY</h4>
                      <div>
                        <label className="block text-[10px] font-mono text-white/50 mb-1">ACTIVITY_NAME</label>
                        <input 
                          type="text" 
                          value={newActName} 
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          <label className="block text-[10px] font-mono text-white/50 mb-1">DURATION (MINS)</label>
                          <input 
                            type="number" 
                        ...
                        <div>
                          <label className="block text-[10px] font-mono text-white/50 mb-1">TIMING</label>
                          <select 
                            value={newActTiming} 
                      ...
                      <button 
                        ...
                        className="w-full bg-purple-600 hover:bg-purple-500 text-white rounded-lg py-2 text-xs font-mono font-bold flex items-center justify-center gap-1.5 cursor-pointer mt-2"
                      >
                    ...
                    <div className="lg:col-span-2 space-y-2 max-h-[280px] overflow-y-auto pr-2">
                      {activities.map((act, index) => (
                        <div key={index} className="flex items-center justify-between bg-white/5 border border-white/5 rounded-xl p-3">
                          <div>
                            <span className="font-mono font-bold text-sm text-purple-200">{act.name}</span>
                            <div className="flex gap-4 text-[10px] text-white/50 mt-1 font-mono">
              ...
              {step === 5 && (
                <div className="space-y-6">
                  <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-mono font-bold">FREQUENT_WEBSITES</h3>
                      <p className="text-xs text-white/50">Register URLs and target daily focus goals for quick-access launchers.</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    {/* Form */}
                    <div className="bg-white/5 p-4 rounded-xl border border-white/5 space-y-3">
                      <h4 className="text-xs font-mono text-purple-400 font-bold mb-2">ADD_WEBSITE_ENTRY</h4>
                      <div>
                        <label className="block text-[10px] font-mono text-white/50 mb-1">PLATFORM_NAME</label>
                        <input 
                          type="text" 
                          value={newWebName} 
                      ...
                      <div>
                        <label className="block text-[10px] font-mono text-white/50 mb-1">URL</label>
                        <input 
                          type="url" 
                          value={newWebUrl} 
                      ...
                      <div>
                        <label className="block text-[10px] font-mono text-white/50 mb-1">DAILY TIME GOAL (MINUTES)</label>
                        <input 
                          type="number" 
                          value={newWebGoal} 
                    ...
                    <div className="lg:col-span-2 space-y-2 max-h-[280px] overflow-y-auto pr-2">
                      {websites.map((site, index) => (
                        <div key={index} className="flex items-center justify-between bg-white/5 border border-white/5 rounded-xl p-3">
                          <div>
                            <span className="font-mono font-bold text-sm text-purple-200">{site.name}</span>
                            <div className="flex gap-4 text-[10px] text-white/50 mt-1 font-mono">
              ...
              {step === 6 && (
                <div className="space-y-6">
                  <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-mono font-bold">ACTIVE_ONLINE_COURSES</h3>
                      <p className="text-xs text-white/50">Track Coursera, Udemy, or platform courses, progress, and goals.</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    {/* Add form */}
                    <div className="bg-white/5 p-4 rounded-xl border border-white/5 space-y-3">
                      <h4 className="text-xs font-mono text-purple-400 font-bold mb-2">ADD_COURSE_ENTRY</h4>
                      <div>
                        <label className="block text-[10px] font-mono text-white/50 mb-1">COURSE_NAME</label>
                        <input 
                          type="text" 
                          value={newCourseName} 
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          <label className="block text-[10px] font-mono text-white/50 mb-1">PLATFORM</label>
                          <input 
                            type="text" 
                            value={newCoursePlatform} 
                            onChange={(e) => setNewCoursePlatform(e.target.value)}
                            placeholder="Udemy, Coursera"
                            className="w-full bg-white/5 border border-white/10 rounded-lg px-2.5 py-1.5 text-xs"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] font-mono text-white/50 mb-1">PROGRESS %</label>
                          <input 
                            type="number" 
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          <label className="block text-[10px] font-mono text-white/50 mb-1">GOAL (HOURS/WK)</label>
                          <input 
                            type="number" 
                            value={newCourseGoal} 
                        ...
                        <div>
                          ...
                          <input 
                            ...
                            className="bg-white/5 border border-white/10 rounded-lg px-1.5 py-1 text-xs w-full"
                          />
                        </div>
                      </div>
                      <button 
                      ...
                      {courses.map((c, index) => (
                        <div key={index} className="flex items-center justify-between bg-white/5 border border-white/5 rounded-xl p-3">
                          <div className="flex-1 mr-4">
                            <span className="font-mono font-bold text-sm text-purple-200">{c.name}</span>
                            <div className="flex gap-4 text-[10px] text-white/50 mt-1 font-mono">
                          ...
                          <div className="flex items-center gap-3">
                            <span className="text-xs font-mono font-bold text-cyan-400">{c.progress}%</span>
              ...
              {step === 7 && (
                <div className="space-y-6 flex flex-col items-center justify-center py-6">
                  <div className="w-16 h-16 rounded-full bg-emerald-950/40 border border-emerald-500/40 flex items-center justify-center text-emerald-400 animate-pulse mb-2">
                    <CheckCircle className="w-10 h-10" />
                  </div>
                  
                  <div className="text-center max-w-md space-y-2">
                    <h3 className="text-xl font-mono font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-emerald-400">OPTIMIZATION_READY</h3>
                  ...
                  {/* Summary Box */}
                  <div className="w-full max-w-md bg-white/5 rounded-xl border border-white/5 p-4 grid grid-cols-2 gap-3 text-xs font-mono">
                    ...
                    <div className="text-right text-purple-300">{subjects.length} courses</div>
          ...
          <div className="flex justify-between items-center border-t border-white/10 pt-6 mt-6">
            <button
              ...
              disabled={step === 1}
              className={`flex items-center gap-1 px-4 py-2 rounded-xl text-xs font-mono border border-white/10 bg-white/5 hover:bg-white/10 active:scale-95 transition cursor-pointer ${
            ...
            {step < totalSteps ? (
              ...
              >
                SAVE_ACADEMIC_PROFILE <ShieldCheck className="w-4 h-4" />
              </button>
            )}
          </div>
        </div>
