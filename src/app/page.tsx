...
export default function RootPage() {
  ...
  useEffect(() => {
    // Small delay for smooth cyber loading animation
    if (!isLoaded) return;
  ...
  return (
    <main className="min-h-screen bg-background flex flex-col items-center justify-center relative overflow-hidden cyber-grid">
      ...
      <div className="hidden w-[300px] h-[300px] bg-primary top-1/4 left-1/4"></div>
      <div className="hidden w-[300px] h-[300px] bg-blue-600 bottom-1/4 right-1/4"></div>
